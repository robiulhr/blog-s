...
app.get("/", function (req, res) {
  res.render("home", { homeDescription: homeStartingContent, showAllpost: allPost });
});
// home About
...
app.get('/posts/:postname', function (req, res) {
  ...
  for (let i = 0; i < allPost.length; i++) {
    let storedtitle = _.lowerCase(allPost[i].title);
    // console.log(storedtitle);
    if (posttitle === storedtitle) {
      // console.log("matched");
      res.render("post", { postTitle: allPost[i].title, postContent: allPost[i].post });
    }
  }
